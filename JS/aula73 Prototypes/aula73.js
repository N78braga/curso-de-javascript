/**
 * Conhecendo o Prototypes
 * 
 * JavaScripté baseado em protótipos para passar propriedades e métodos
...
function Pessoa(nome, sobreNome){
     ...
     this.nomeComplto = () => this.nome + ' ' + this.sobreNome;
}
Pessoa.prototype.nomeComplto = function(){
